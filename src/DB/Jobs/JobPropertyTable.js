...
JPT[JOB.SHINKIRO] = DJP(1, 0, 0, 0, 0, 0, 1, 0, 0, 1, JOB.NINJA, JOB.KAGEROU, JOB.SHINKIRO);
JPT[JOB.SHIRANUI] = DJP(1, 0, 0, 0, 0, 0, 1, 0, 0, 1, JOB.NINJA, JOB.OBORO, JOB.SHIRANUI);
JPT[JOB.NIGHT_WATCH] = DJP(1, 0, 0, 0, 0, 0, 1, 0, 0, 1, JOB.GUNSLINGER, JOB.REBELLION, JOB.NIGHT_WATCH);
JPT[JOB.HYPER_NOVICE] = DJP(1, 0, 1, 0, 0, 0, 1, 0, 0, 1, JOB.SUPERNOVICE, JOB.SUPERNOVICE2, JOB.HYPER_NOVICE);
JPT[JOB.SPIRIT_HANDLER] = DJP(0, 1, 0, 0, 0, 0, 1, 0, 0, 1, JOB.DO_SUMMONER, JOB.SPIRIT_HANDLER);
